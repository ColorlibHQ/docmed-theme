...
function docmed_widgets_init() {
    // sidebar widgets register
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'docmed' ),
        'id'            => 'docmed-post-sidebar',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'docmed' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'docmed' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'docmed' ),
        'id'            => 'footer-4',
...
add_action( 'widgets_init', 'docmed_widgets_init' );
