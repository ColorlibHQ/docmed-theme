...
// image default alt
if ( ! function_exists( 'docmed_img_default_alt' ) ) {
	function docmed_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'docmed_img_tag' ) ) {
	function docmed_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = docmed_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'docmed_anchor_tag' ) ) {
	function docmed_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'docmed_heading_tag' ) ) {
	function docmed_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'docmed_paragraph_tag' ) ) {
	function docmed_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'docmed_other_tag' ) ) {
	function docmed_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'docmed_button_element ' ) ) {
	function docmed_button_element( array $args ) {
