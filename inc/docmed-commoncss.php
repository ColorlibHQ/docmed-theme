...
// enqueue css
function docmed_common_custom_css(){
    
    wp_enqueue_style( 'docmed-common', get_template_directory_uri().'/assets/css/common.css' );
		...
		$headerTop_bg     		  = '';
		$navbarBgColor     		  = docmed_opt( 'docmed_navbar_bg_color' ) != '#082b49' ? docmed_opt( 'docmed_navbar_bg_color') : '';
		$headerTop_col     		  = docmed_opt( 'docmed_top_header_color' );

		$headerTopBg      		  = docmed_opt( 'docmed_top_header_bg_color');
		$headerBg          		  = docmed_opt( 'docmed_header_bg_color') != '#ffffff' ? docmed_opt( 'docmed_header_bg_color') : '';
		$menuColor          	  = docmed_opt( 'docmed_header_menu_color' ) != '#131313' ? docmed_opt('docmed_header_menu_color') : '';
		$menuHoverColor           = docmed_opt( 'docmed_header_menu_hover_color' ) != '#808080' ? docmed_opt('docmed_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = docmed_opt( 'docmed_header_menu_fixed_hover_color' );
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .docmed_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .docmed_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'docmed-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'docmed_common_custom_css', 50 );